...
samples: 10000; evals/sample: 1000; memory estimate: 0 bytes; allocs estimate: 0
   ...
   3.4 │⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀│ 
     ...
     0 │⠀⠀⠀⠀⠀⠀⠀⠀⢸⣀⣀⣿⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⡀│ 
       ...
       0                                       30
                          ns
min: 6.166 ns (0.00% GC); mean: 6.810 ns (0.00% GC); median: 6.291 ns (0.00% GC); max: 29.541 ns (0.00% GC).
```
...
```
samples: 3128; evals/sample: 1000; memory estimate: 0 bytes; allocs estimate: 0
          ┌────────────────────────────────────────┐ 
   0.0078 │⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀│ 
          │⡆⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀│ 
          │⡇⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀│ 
        ...
        0 │⠀⠀⠀⠀⠀⠀⢸⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⣀⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀│ 
          ...
          0                                    20000
                             ns
min: 1.875 ns (0.00% GC); mean: 1.146 μs (0.00% GC); median: 4.708 ns (0.00% GC); max: 10.244 μs (0.00% GC).
```
...
```
samples: 2419; evals/sample: 1000; memory estimate: 0 bytes; allocs estimate: 0
          ┌────────────────────────────────────────┐ 
   0.0057 │⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀│ 
          │⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⡆⠀⠀⠀⠀⠀⠀⠀⠀│ 
          │⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣿⠀⠀⠀⠀⠀⠀⠀⠀│ 
        ...
        0 │⠎⠑⠊⠙⠚⠛⠒⠒⠚⠓⠚⠣⠒⠲⠦⠴⠴⠖⠤⠶⠤⠤⠤⠤⡴⠤⡴⡔⠢⠤⣼⠀⠸⣄⣀⣀⠀⠀⠀⠀│ 
          ...
          0                                     4000
                             ns
min: 1.916 ns (0.00% GC); mean: 1.984 μs (0.00% GC); median: 2.147 μs (0.00% GC); max: 3.599 μs (0.00% GC).
```
